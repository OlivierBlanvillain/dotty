...
class Definitions {
  ...
  def FunctionClass0(implicit ctx: Context): Symbol = ??? // TODO OLIVIER FunctionClassPerRun()(ctx)(0)
  def FunctionClass1(implicit ctx: Context): Symbol = ??? // TODO OLIVIER FunctionClassPerRun()(ctx)(1)
  // val Function1: Tyope
