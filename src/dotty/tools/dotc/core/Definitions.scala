...
class Definitions {
  ...
  // lazy val TupleType: Array[TypeRef] = mkArityArray("scala.Tuple", MaxTupleArity, 2)
  // lazy val ProductNType: Array[TypeRef] = mkArityArray("scala.Product", MaxTupleArity, 0)
