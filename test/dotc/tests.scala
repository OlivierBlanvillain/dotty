...
//   @Test def pos_companions = compileFile(posDir, "companions", twice)
  ...
  @Test def neg_all = compileFiles(negDir)
...
//   // @Test def repl_all = replFiles(replDir) // FOR NOWWWWWWWWWWW
...
//   //       |./scala-scala/src/library/scala/collection/generic/GenSeqFactory.scala""".stripMargin) // FOR NOWWWWWWWWWWW
