...
trait LegacyTupleSyntax {
  ...
  // implicit def tupleCons2ToTuple2[A, B](l: TupleCons[A, TupleCons[B, TNil.type]]): scala.Tuple2[A, B] =
  //   scala.Tuple2[A, B](l.h5ead, l.tail.head)
  ...
  implicit class Tuple3Assessors[A, B, C](l: TupleCons[A, TupleCons[B, TupleCons[C, TNil.type]]]) {
    ...
    //   (implicit w1: A <:< CC1[El1],
    //             w2: B <:< CC2[El2],
    //             w3: C <:< CC3[El3],
    //             bf: scala.collection.generic.CanBuildFrom[CC1[_], (El1, El2, El3), That]
    //   ): That = {
    //     val buf = bf(_1)
    //     val it1 = _1.toIterator
    //     val it2 = _2.toIterator
    //     val it3 = _3.toIterator
    ...
    //   (implicit w1: A => scala.collection.TraversableLike[El1, Repr1],
    //             w2: B => scala.collection.IterableLike[El2, Repr2],
    //             w3: C => scala.collection.IterableLike[El3, Repr3]
    //   ): scala.runtime.Tuple3Zipped[El1, Repr1, El2, Repr2, El3, Repr3] = new scala.runtime.Tuple3Zipped((_1, _2, _3))
  }
