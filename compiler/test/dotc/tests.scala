...
// @Test def pickle_pickling = compileDir(coreDir, "pickling", testPickling)
  ...
  // @Test def repl_all = replFiles(replDir) ø
  ...
  // @Test def compileParSetLike = compileLine("../scala-scala/src/library/scala/collection/parallel/mutable/ParSetLike.scala") ø
